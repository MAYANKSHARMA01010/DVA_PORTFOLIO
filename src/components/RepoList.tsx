...
import { Project, Category } from "../data"

const CATEGORIES: Category[] = ["All", "AI/ML", "AI Systems", "Data Analytics"]
...
export default function RepoList({ projects, activeFilter, setActiveFilter, onCardClick }: RepoListProps) {
  const filtered =
    activeFilter === "All"
      ? projects
  ...
  return (
    <div className="repo-list">
      <div className="repo-list-header">
        ...
        <span className="repo-list-title">Projects</span>
      ...
      <div className="repo-grid">
        {filtered.map((project) => (
          <RepoCard key={project.name} project={project} onClick={onCardClick} />
        ))}
      </div>
    </div>
  )
